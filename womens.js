...
templates['womens'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <div class=\"shoes-card\">\n            <div class=\"img-div\">\n                <img class=\"shoe-img\" src="
    ...
    + "\n"
    + ((stack1 = (helpers.colors || (depth0 && depth0.colors) || helpers.helperMissing).call(alias3,(depth0 != null ? depth0.noOfColors : depth0),{"name":"colors","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
    + "                </p>\n                <div class=\"hover-colors-div\">\n                    <div class=\"color-carousel\">\n"
    + ((stack1 = helpers.each.call(alias3,(depth0 != null ? depth0.colorImgs : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    ...
    return "                        <img class=\"carousel-img\" src="
